          ...
          "items": [
            {
              "required": true,
              "type": "radio",
              "label": "Is dit de eerste keer dat je de training doet?",
              "options": [
                {
                  "label": "Ja",
                  "coding": "yes"
          ...
          "items": [
            {
              ...
              "help": "Gebruik hetzelfde e-mailadres voor elke trainingsessie.",
              "name": "participant_id",
              "attributes": {
                "type": "email"
              }
                ...
                "items": [
                  {
                    "required": false,
                    "type": "input",
                    "label": "Typ hieronder het wachtwoord dat je kreeg tijdens jouw vorige trainingssessie:",
                    "name": "password",
                    "help": "Ter herinnering: het wachtwoord heeft 4 cijfers.",
                    "attributes": {
                      "type": "number",
                      "min": "1000",
                      "max": "9999"
...
if (this.state.valid_passwords.includes(this.state.password_numeric)) {
  ...
  this.state.password_validity = 0;
                ...
                "items": [
                  {
                    ...
                    "content": "Het door u ingevoerde wachtwoord was niet juist. U hebt het misschien verkeerd ingevoerd!"
                  }
                ],
                "scrollTop": true,
                "submitButtonText": "Probeer opnieuw",
                "submitButtonPosition": "right",
                "files": {},
                "responses": {
                  "": ""
        ...
        },
        {
          ...
          "content": "\u003Cmain\u003E \n  \u003Cdiv class=\"introduction-central-container\"\u003E\n\n    \u003Cdiv class=\"inner-main-divs\"\u003E\n    \u003Cimg src=\"static\u002Fprofessor.jpeg\"\u003E\n    \u003C\u002Fdiv\u003E\n\n    \u003Cdiv class=\"inner-main-divs\"\u003E\n      \u003Cp class=\"inner-main-divs\"\u003EHallo! Ik ben Professor SMART, en welkom bij SMART Brain Training!\u003Cbr\u003E\u003Cbr\u003EHet doel van mijn training is om je hersenen zo slim mogelijk te maken – specifiek door moeilijke problemen snel en correct te kunnen beantwoorden!\u003Cbr\u003E\u003Cbr\u003EDe komende weken ga je meer dan 100 niveaus van mijn speciale training doorlopen. We hebben veel werk te doen.\u003Cbr\u003E\u003Cbr\u003EMaar maak je geen zorgen – ik weet dat je de uitdaging aankunt! \u003Cbr\u003E\u003Cbr\u003E\n\n      \u003Cbutton id=\"continue\"\u003EDoorgaan\u003C\u002Fbutton\u003E\n      \u003C\u002Fdiv\u003E\n\n    \u003C\u002Fdiv\u003E\n\n  \u003C\u002Fmain\u003E",
          "tardy": true,
...
this.state.current_pokemon_name = this.state.current_pokemon_image.split(' ').shift().split('/').pop();
          ...
          "content": "\u003Cmain\u003E \n  \u003Cdiv class=\"introduction-central-container\"\u003E\n\n    \u003Cdiv\u003E\n    \u003Cimg src=\"static\u002Fprofessor.jpeg\"\u003E\n    \u003C\u002Fdiv\u003E\n\n    \u003Cdiv\u003E\n\n      \u003Cdiv\u003E\n      \u003Cp\u003EOm te beginnen laten we je zien hoe de training werkt.\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\n\n      \u003Cdiv\u003E\n      \u003C\u002Fdiv\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\n      \u003Cbutton id=\"continue\"\u003EDoorgaan\u003C\u002Fbutton\u003E\n\n    \u003C\u002Fdiv\u003E\n\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E",
          "tardy": true,
          "skip": "${this.state.first_time == \"no\"}"
        },
        {
          ...
          "content": "\u003Cmain\u003E \n  \u003Cdiv class=\"introduction-central-container\"\u003E\n\n    \u003Cdiv\u003E\n    \u003Cimg src=\"static\u002Fprofessor.jpeg\"\u003E\n    \u003C\u002Fdiv\u003E\n\n    \u003Cdiv\u003E\n      \u003Cp\u003EZoals ik al zei, zijn er veel verschillende niveaus in de training. Je doel is om zo veel mogelijk niveaus te halen!\u003Cbr\u003E\u003Cbr\u003EElk niveau bestaat uit twee delen: een \u003Ckbd\u003Etrainingsgedeelte\u003C\u002Fkbd\u003E en een \u003Ckbd\u003Etestgedeelte\u003C\u002Fkbd\u003E. In beide delen lees je hoe verschillende verzonnen woorden samenhangen (bijvoorbeeld: CUG is hetzelfde als JOM, JOM is hetzelfde als VEK). Vervolgens krijg je een vraag over deze verzonnen woorden (bijvoorbeeld: Is CUG hetzelfde als VEK?).\u003Cbr\u003E\u003Cbr\u003EJe doel is om deze vraag zo snel en nauwkeurig mogelijk te beantwoorden door met de muis op “JA” of “NEE” te klikken.\u003Cbr\u003E\u003Cbr\u003EIn het \u003Ckbd\u003Etrainingsgedeelte\u003C\u002Fkbd\u003E zal ik je vertellen of je antwoord juist of fout was. Maar in het \u003Ckbd\u003Etestgedeelte\u003C\u002Fkbd\u003E vertel ik je dit niet!\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cbutton id=\"continue\"\u003EDoorgaan\u003C\u002Fbutton\u003E\n      \u003C\u002Fdiv\u003E\n\n    \u003C\u002Fdiv\u003E\n\n  \u003C\u002Fmain\u003E",
          "tardy": true,
          "skip": "${this.state.first_time == \"no\"}"
        },
        {
...
this.state.password = 3368
          ...
          "content": "\u003Cmain\u003E \n  \u003Cdiv class=\"introduction-central-container\"\u003E\n\n    \u003Cdiv class=\"inner-main-divs\"\u003E\n    \u003Cimg src=\"static\u002Fprofessor.jpeg\"\u003E\n    \u003C\u002Fdiv\u003E\n\n    \u003Cdiv\u003E\n      \u003Cp\u003EElk niveau in SMART wordt moeilijker en moeilijker. In het \u003Ckbd\u003Etrainingsgedeelte\u003C\u002Fkbd\u003E van elk niveau blijf je vragen beantwoorden totdat je 16 juiste antwoorden op een rij hebt. Zodra je dit doet, ga je over naar een \u003Ckbd\u003Etestgedeelte\u003C\u002Fkbd\u003E. Het \u003Ckbd\u003Etestgedeelte\u003C\u002Fkbd\u003E is in totaal slechts 16 proeven lang!\u003Cbr\u003E\u003Cbr\u003EAls je alle 16 vragen juist hebt, ga je door naar het volgende niveau! Maar, als je ook maar één vraag fout hebt, moet je terug naar het \u003Ckbd\u003Etrainingsgedeelte\u003C\u002Fkbd\u003E van hetzelfde niveau. Dit maakt mijn training soms erg moeilijk, maar je hersenen op deze manier uitdagen is de beste manier om ze slimmer te maken – en dat is wetenschappelijk bewezen!\u003Cbr\u003E\u003Cbr\u003EOnthoud ook dat dit een hersentrainingsprogramma is, en \u003Cb\u003EGEEN\u003C\u002Fb\u003E test. Dit betekent dat fouten maken normaal is en dit maakt deel uit van het leerproces.\u003Cbr\u003E\u003Cbr\u003EJe leert niet fietsen zonder er eerst een paar keer te af vallen - en hetzelfde geldt voor elk type vaardigheid! 😊 Voel je dus niet slecht als je fouten maakt, of als je het moeilijk vindt. Na een tijdje wordt het makkelijker – het draait allemaal om hard oefenen en niet opgeven!\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cbutton id=\"continue\"\u003EDoorgaan\u003C\u002Fbutton\u003E\n      \u003C\u002Fdiv\u003E\n\n    \u003C\u002Fdiv\u003E\n\n  \u003C\u002Fmain\u003E",
          "tardy": true,
          "skip": "${this.state.first_time == \"no\"}"
        },
        {
          ...
          "content": "\u003Cmain\u003E \n  \u003Cdiv class=\"introduction-central-container\"\u003E\n\n    \u003Cdiv\u003E\n    \u003Cimg src=\"static\u002Fprofessor.jpeg\"\u003E\n    \u003C\u002Fdiv\u003E\n\n    \u003Cdiv\u003E\n\n      \u003Cdiv\u003E\n      \u003Cp\u003EWelkom terug bij Professor SMART's SMART Brain Training! Ik ben blij je weer te zien! Laten we je meteen weer inwerken om verder te gaan op je reis door mijn training!\u003C\u002Fdiv\u003E\n\n      \u003Cdiv\u003E\n      \u003C\u002Fdiv\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\n      \u003Cbutton id=\"continue\"\u003EDoorgaan\u003C\u002Fbutton\u003E\n\n    \u003C\u002Fdiv\u003E\n\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E",
          "tardy": true,
...
this.state.phase = "Training"
          ...
          "content": "\u003Cmain\u003E \n  \u003Cdiv class=\"introduction-central-container\"\u003E\n\n    \u003Cdiv class=\"inner-main-divs\"\u003E\n    \u003Cimg src=\"static\u002Fprofessor.jpeg\"\u003E\n    \u003C\u002Fdiv\u003E\n\n    \u003Cdiv\u003E\n      \u003Cp\u003EZodra je op “begin training” klikt, begin je mijn hersentraining voor 30 minuten.\u003Cbr\u003E\u003Cbr\u003ELet in die tijd zo goed mogelijk op. Als je problemen hebt, noteer ze dan en vertel het de onderzoeker wanneer je kunt.\u003Cbr\u003E\u003Cbr\u003EOh, een ander belangrijk ding! Probeer alsjeblieft niet op de “refresh” knop te klikken tijdens de training. Als je dit doet, dan word je helemaal teruggebracht naar het begin en verlies je misschien de vooruitgang die je in deze sessie maakt!\u003Cbr\u003E\u003Cbr\u003EVeel succes, en doe je best!  \n\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cbutton id=\"continue\"\u003EBegin Training\u003C\u002Fbutton\u003E\n      \u003C\u002Fdiv\u003E\n\n    \u003C\u002Fdiv\u003E\n\n  \u003C\u002Fmain\u003E",
          "tardy": true
        }
      ]
    },
...
sessiontimer = setInterval(function(){
  if(session_time_left <= 0){
    ...
    document.getElementById("session-countdown").innerHTML = "Nog " + Math.trunc(session_minutes_left) + " minuten";
  }
  session_time_left -= 1;
...
this.state.url_text = "https://www.drjamiecummins.com/smart-trials/nl/stage_";
...
document.getElementById("pokemon-motivation").innerHTML = "Laten we beginnen. Je kunt dit!";
};


if (this.state.phase == "Training") {
  document.getElementById("trial-display").innerHTML = this.state.current_tally + " van de 16 correct";
} else if (this.state.phase == "Testing") {
  document.getElementById("trial-display").innerHTML = "Trial " + this.state.testing_trial_number + " van 16";
}
...
motivations = ['Hoe meer we oefenen, hoe beter we worden!',
                  ...
                  "items": [
                    {
                      "type": "text",
                      "title": "Goed gedaan!",
                      "content": "Je hebt 16 antwoorden op rij goed in het trainingsgedeelte van dit level! Je gaat nu door naar het testgedeelte.\u003Cbr\u003E\u003Cbr\u003EAls je alle 16 testvragen goed hebt, ga je naar het volgende level. Maar let op: als je er ook maar één fout hebt, moet je het trainingsgedeelte helemaal opnieuw beginnen!\u003Cbr\u003E\u003Cbr\u003EAls je klaar bent, klik je op 'doorgaan' om het testgedeelte van dit level te beginnen. Veel succes!"
                    }
                  ],
                  "scrollTop": true,
                  "submitButtonText": "Doorgaan →",
                  ...
                  "items": [
                    {
                      "type": "text",
                      "title": "",
                      "content": "Je hebt niet alle vragen goed gekregen in die ronde. Je gaat terug naar het trainingsgedeelte van dit niveau. Maak je geen zorgen - oefening baart kunst! Blijf proberen en je komt er wel. Als je klaar bent, klik je op \"doorgaan\" om door te gaan. Veel succes!"
                    }
                  ],
                  "scrollTop": true,
                  "submitButtonText": "Doorgaan →",
...
this.state.skip_chunk = 1
                      ...
                      "title": "next_stage",
                      "content": "\u003Cmain\u003E \n  \u003Cdiv class=\"introduction-central-container\"\u003E\n\n    \u003Cdiv\u003E\n    \u003Cimg src=\"static\u002Fprofessor.jpeg\"\u003E\n    \u003C\u002Fdiv\u003E\n\n    \u003Cdiv\u003E\n\n      \u003Cdiv\u003E\n      \u003Cp\u003EJe hebt zojuist een nieuw level vrijgespeeld - geweldig gedaan!\u003Cbr\u003E\u003Cbr\u003ENeem gerust een paar seconden pauze, en als je klaar bent, klik je op \"Doorgaan\" om naar het volgende level te gaan. Veel succes!\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\n      \u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\u003Cbr\u003E\n      \u003Cbutton id=\"continue\"\u003EDoorgaan\u003C\u002Fbutton\u003E\n\n    \u003C\u002Fdiv\u003E\n\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E",
                      "tardy": true,
                      "skip": "${this.state.skip_chunk == 1}"
                    }
                  ]
...
if (this.state.stage == 5) { 
 ...
 this.state.password = '4545'
      ...
      "content": "\u003Cmain\u003E \n  \u003Cdiv class=\"introduction-central-container\"\u003E\n\n    \u003Cdiv\u003E\n    \u003Cimg src=\"static\u002Fprofessor.jpeg\"\u003E\n    \u003C\u002Fdiv\u003E\n\n    \u003Cdiv\u003E\n\n      \u003Cdiv\u003E\n      \u003Cp\u003EGoed gedaan. Je bent net klaar met de training van vandaag!\u003Cbr\u003E\u003Cbr\u003EDat was veel werk. Laten we vandaag even rusten en fris terugkomen voor de volgende sessie. Goed werk! \u003Cbr\u003E\u003Cbr\u003EJe wachtwoord voor de volgende training is: \u003Cb\u003E${this.state.password}\u003C\u002Fb\u003E. Schrijf dit ergens op zodat je het niet vergeet!\u003Cbr\u003E\u003Cbr\u003EJe kunt deze webpagina sluiten wanneer je maar wilt, zodra je je wachtwoord hebt opgeschreven - en ik zie je de volgende keer!\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\n\n    \u003C\u002Fdiv\u003E\n\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E",
      "tardy": true
    }
  ]
})
